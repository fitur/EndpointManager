...
$DPGName = "All DPs"
$TSLaunchSourcePath = "\\<sccm-server>\sources\OSD\Scripts and Tools\TSLaunch\TSLaunch - 1809 - Source"
$TSLaunchDestinationPrefix = "\\<sccm-server>\sources\OSD\Scripts and Tools\TSLaunch\TSLaunch - 1809"
